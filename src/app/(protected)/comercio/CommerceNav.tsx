...
export default function CommerceNav({ labels }: CommerceNavProps) {
  const pathname = usePathname();

  const navItems = [
    { href: "/comercio", label: labels.summary },
    { href: "/comercio/excedentes", label: labels.excedentes },
    { href: "/comercio/planes", label: labels.planes },
    { href: "/comercio/configuracion", label: labels.settings },
  ];
